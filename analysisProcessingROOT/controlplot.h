...
public:
    ...
    // Existing histograms
    TH1F *recojetpt_eff_den1, *recojetpt_eff_num1, *seedjetpt_eff_den1, *seedjetpt_eff_num1;
    TH1F *recojeteta_eff_den1, *recojeteta_eff_num1, *recojetphi_eff_den1, *recojetphi_eff_num1;
    TH1F *seedjeteta_eff_den1, *seedjeteta_eff_num1, *seedjetphi_eff_den1, *seedjetphi_eff_num1;
    TH1F *l1jetpt, *l1jetpt_rate1;

    // New histograms for resolutions
    TH1F *h_resolution_l1Pt;
    TH1F *h_resolution_seedPt;
