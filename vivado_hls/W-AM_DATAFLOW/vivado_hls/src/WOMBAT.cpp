...
void WOMBAT(
    ...
    // #pragma HLS ARRAY_RESHAPE variable=inputs_misc_v2_ft20 complete dim=0
    // #pragma HLS ARRAY_PARTITION variable=layer16_out complete dim=0
    // #pragma HLS INTERFACE ap_vld port=inputs_misc_v2_ft20,layer16_out 
    // #pragma HLS DATAFLOW 
  //  #pragma HLS Inline
    #pragma HLS PIPELINE II=4
    #pragma HLS latency max=22
    ...
    nnet::relu30<layer2_t, layer5_t, relu_config5>(layer2_out, layer5_out); // act1_misc_v2_ft20


    layer4_t layer4_out[OUT_HEIGHT_2*OUT_WIDTH_2*N_FILT_2];
    #pragma HLS ARRAY_PARTITION variable=layer4_out complete dim=0
    nnet::normalize<layer5_t, layer4_t, config4>(layer5_out, layer4_out, s4, b4); // bn1_misc_v2_ft20


    layer6_t layer6_out[OUT_HEIGHT_6*OUT_WIDTH_6*N_FILT_6];
    #pragma HLS ARRAY_PARTITION variable=layer6_out complete dim=0
    nnet::conv_2d_cl<layer4_t, layer6_t, config6>(layer4_out, layer6_out, w6, b6); // conv2_misc_v2_ft20
